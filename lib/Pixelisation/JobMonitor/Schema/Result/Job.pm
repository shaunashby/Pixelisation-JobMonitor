package Pixelisation::JobMonitor::Schema::Result::Job;
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ga3vVjROCZI8uIoRJC+c1g
__PACKAGE__->add_columns(
        "instrument",
        { data_type => 'TEXT', is_nullable => 0, size => undef },
        "dataset",
        { data_type => 'TEXT', is_nullable => 0, size => undef, default => 'full' },
        "created",
